            ...
            messages=[
                {
                    ...
                    Пиши уверенно, используй термины разные термины и жаргон капперов(пофессиональных аналитиков).
    ...
    def _create_prompt(self, title, coefficients, full_text, start_time):
        return f"""Анализ матча: {title}
                    ...
                    {{
                        ...
                        "краткая_аналитика": "1-2 четких предложения: почему эта ставка зайдет.",
